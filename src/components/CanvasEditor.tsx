  ...
  return (
    <div className="canvas-container">
      <div className="relative">
        ...
        {isInitializing && (
          <div className="absolute inset-0 flex items-center justify-center bg-surface-dark bg-opacity-70">
            <div className="text-center p-6">
              <svg className="loading-spinner mx-auto h-10 w-10 text-primary mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
