...
const RightSidebar: React.FC<RightSidebarProps> = ({
  ...
  return (
    <div className="p-4 overflow-y-auto h-full bg-white">
      <h2 className="heading-1">Editor</h2>

      <Accordion type="multiple" className="w-full" defaultValue={["palette", "text", "shapes"]}>
        {/* PALETTE SECTION */}
        <AccordionItem value="palette" className="accordion">
          ...
          <AccordionContent>
            <div className="p-4">
              ...
              <div className="mb-4">
                ...
                {palette.length > 0 && (
                  <div className="mb-4">
                    <h4 className="field-label mb-1">Colores extraídos</h4>
              ...
              <div>
                <h4 className="field-label mb-2">Colores básicos</h4>
                <div className="flex gap-4">
                  <div className="flex-1">
                    <span className="field-label block">Fondo</span>
                    <div
                  ...
                  <div className="flex-1">
                    <span className="field-label block">Texto</span>
                    <div
        ...
        {/* TEXT SECTION */}
        <AccordionItem value="text" className="accordion">
          <AccordionTrigger className="accordion-header">
            Contenido de texto
          </AccordionTrigger>
          <AccordionContent>
            <div className="p-4">
              {/* Quote Controls */}
              <div className="mb-6">
                <h3 className="field-label mb-2">Cita</h3>
                <textarea
                  value={quote}
              ...
              {/* Signature Controls */}
              <div>
                <h3 className="field-label mb-2">Firma</h3>
                <textarea
                  value={signature}
        ...
        {/* SHAPES SECTION */}
        <AccordionItem value="shapes" className="accordion">
          <AccordionTrigger className="accordion-header">
            Elementos gráficos
          </AccordionTrigger>
          <AccordionContent>
            <div className="p-4">
              <h3 className="field-label mb-3">Insertar formas</h3>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col gap-1">
                  <label className="field-label">Grosor</label>
                  <input
                    type="number"
                    min={1}
                    max={20}
